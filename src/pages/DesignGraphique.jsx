// src/components/pages/DesignGraphique.jsx
import { motion } from "framer-motion";
import { CheckCircle2, ArrowRight, Brush, Layout, Smartphone, Package, Layers } from "lucide-react";
import { Link } from "react-router-dom";

export default function DesignGraphique() {
  ...
  const services = [
    { icon: <Brush className="w-5 h-5" />, name: "Identité Visuelle", desc: "Création de logos, chartes graphiques et éléments visuels qui définissent l'essence de votre marque." },
    { icon: <Layout className="w-5 h-5" />, name: "Supports Marketing", desc: "Conception de brochures, flyers, affiches et cartes de visite pour une communication percutante." },
    { icon: <Smartphone className="w-5 h-5" />, name: "Design Web & Mobile", desc: "Création d'interfaces utilisateur (UI) et d'expériences (UX) visuellement attrayantes et intuitives." },
    { icon: <Package className="w-5 h-5" />, name: "Packaging", desc: "Conception d'emballages qui attirent l'attention et reflètent la qualité de vos produits." },
    { icon: <Layers className="w-5 h-5" />, name: "Illustrations & Infographies", desc: "Création de visuels sur mesure pour expliquer des concepts complexes de manière claire et artistique." },
  ];

  const benefits = [
    "Une identité de marque forte et mémorable",
    "Des supports de communication professionnels et cohérents",
    "Une image crédible et une connexion émotionnelle avec votre public",
    "Une communication visuelle qui se démarque de la concurrence",
  ];
    ...
    <div className="font-inter">
      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-emerald-500 text-white py-28 px-4 md:px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            Donnez vie à votre marque avec un design unique et professionnel qui captivera votre audience.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <h2 className="font-poppins text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Le design au service de votre message
            </h2>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6 text-justify">
              Un design de qualité n'est pas qu'une question d'esthétique. C'est un puissant outil de communication qui renforce l'identité de votre marque, inspire confiance et attire l'attention de votre public cible.
            </p>
      ...
      <section className="py-12 px-4 md:px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto text-center mb-8">
          ...
          >
            Nous proposons une gamme complète de services pour donner vie à vos idées, de la conception à la réalisation.
          </motion.p>
        </div>
        <motion.div
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              className="text-base text-gray-600 max-w-2xl mx-auto text-justify"
            >
              Un processus transparent et collaboratif pour un résultat qui dépasse vos attentes.
            </motion.p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            <div className="hidden md:block absolute top-12 left-0 right-0 h-1 bg-gray-200 mx-16"></div>
            {[
              { step: "01", title: "Analyse & Briefing", desc: "Compréhension approfondie de vos besoins, de vos valeurs et de votre public." },
              { step: "02", title: "Conception & Croquis", desc: "Création de concepts et de maquettes qui donnent vie à votre idée." },
              { step: "03", title: "Feedback & Itérations", desc: "Nous vous présentons les propositions et ajustons le design selon vos retours." },
              { step: "04", title: "Finalisation & Livraison", desc: "Préparation des fichiers finaux, prêts pour l'impression ou le web." }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="relative py-16 px-4 md:px-6 text-center text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB...')] opacity-20"></div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          >
            Prêt à donner une identité visuelle forte à votre projet ?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Contactez notre équipe de designers pour une consultation gratuite et sans engagement.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
