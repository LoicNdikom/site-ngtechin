// src/components/pages/Videosurveillance.jsx
import { motion } from "framer-motion";
import { CheckCircle2, MonitorSmartphone, ShieldCheck, Eye, Wifi } from "lucide-react";
...
export default function Videosurveillance() {
  ...
  const technologies = [
    { icon: <MonitorSmartphone size={40} className="text-emerald-500" />, name: "Caméras IP Haute Définition", desc: "Qualité d'image supérieure pour identifier visages et plaques d'immatriculation." },
    { icon: <Eye size={40} className="text-blue-600" />, name: "Vision Nocturne Infrarouge", desc: "Surveillance efficace même dans l'obscurité totale." },
    { icon: <Wifi size={40} className="text-emerald-500" />, name: "Accès à Distance et Alertes", desc: "Visualisez vos flux en direct et recevez des notifications instantanées." },
    { icon: <ShieldCheck size={40} className="text-blue-600" />, name: "Analyse Vidéo Intelligente", desc: "Détection de mouvement, franchissement de ligne et comptage de personnes." },
  ];

  const benefits = [
    "Protection et dissuasion contre les intrusions",
    "Surveillance en temps réel de votre propriété",
    "Preuves vidéo fiables en cas d'incident",
    ...
    <div className="font-inter">
      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-emerald-500 text-white py-28 px-4 md:px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            Protégez vos biens et vos proches avec des systèmes modernes, fiables et connectés.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            <h2 className="font-poppins text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Une solution de sécurité adaptée à chaque besoin
            </h2>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6 text-justify">
              Que ce soit pour une résidence privée, un bureau ou un entrepôt, la vidéosurveillance est la première ligne de défense contre les menaces. Elle dissuade les comportements malveillants et fournit des preuves essentielles en cas d'incident.
            </p>
      ...
      <section className="py-12 px-4 md:px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto text-center mb-8">
          ...
          >
            Technologies de Pointe et Équipements Certifiés
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Nous sélectionnons et installons le meilleur matériel pour une surveillance efficace 24/7.
          </motion.p>
        </div>
        <motion.div
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <motion.h2
              ...
              className="font-poppins text-2xl md:text-3xl font-bold text-gray-900 mb-3"
            >
              Notre Méthodologie d'Installation
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-base text-gray-600 max-w-2xl mx-auto text-justify"
            >
              Un processus étape par étape pour une installation discrète et performante.
            </motion.p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            <div className="hidden md:block absolute top-12 left-0 right-0 h-1 bg-gray-200 mx-16"></div>
            {[
              { step: "01", title: "Audit & Consultation", desc: "Analyse des risques et définition de vos besoins spécifiques." },
              { step: "02", title: "Planification & Design", desc: "Création d'un plan détaillé pour un placement optimal des caméras." },
              { step: "03", title: "Installation", desc: "Mise en place professionnelle du matériel et du câblage." },
              { step: "04", title: "Configuration & Suivi", desc: "Paramétrage des systèmes et formation pour une prise en main facile." }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
